...
- [Difference from other CI](#difference-from-other-ci)
  ...
  - [Set environment variables for next steps](#set-environment-variables-for-next-steps)
...
- [Basic - Fundamentables](#basic---fundamentables)
  ...
  - [Redundant build control](#redundant-build-control)
  - [if and context](#if-and-context)
  - [Reusable workflow](#reusable-workflow)
- [Basic - Branch and tag handling](#basic---branch-and-tag-handling)
...
- [Basic - Commit handling](#basic---commit-handling)
